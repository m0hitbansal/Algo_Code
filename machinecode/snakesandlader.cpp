    ...
    void startGame(){
        while(isGameRunning){
            for(int i=0;i<players.size();i++){
                ...
                int curPositions;
                if( p.curPositions+diceOutcome<=100)
                  curPositions=p.curPositions+diceOutcome;
                else
                 curPositions=p.curPositions;
                ...
                if(curPositions ==100){
                    ...
                    cout<<p.playerName + " rolled a "<<diceOutcome <<" and moved from "<<players[i].curPositions <<" to "<< curPositions<<endl;
